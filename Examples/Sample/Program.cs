...
await client!.SubscribeToBalanceUpdatesAsync(new SubscribeBalancesRequest(listenKey: null, tradingMode: TradingMode.PerpetualLinear, exchangeParameters: null), (update) =>
{
